    ...
    public int update(@NonNull Uri uri,
        ...
        switch (sURIMatcher.match(uri)){
            case 3:
                ...
                userUpdate.firstName = contentValues.getAsString(UsuarioProviderContract.FIRSTNAME_COLUMN);

                userUpdate.lastName = contentValues.getAsString(UsuarioProviderContract.LASTNAME_COLUMN);
